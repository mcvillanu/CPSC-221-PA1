...
class Chain {
 ...
 private:
  ...
  /**
   * Helper function to swap two nodes if they are side by side.
   * @param first = the Node to swap that comes first in the chain.
   * @param second = the Node to swap that comes second in the chain. 
   */
